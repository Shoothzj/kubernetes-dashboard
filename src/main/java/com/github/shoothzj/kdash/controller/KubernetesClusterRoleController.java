...
import com.github.shoothzj.kdash.module.DeleteClusterRoleReq;
...
public class KubernetesClusterRoleController {
    ...
    @DeleteMapping("/cluster-roles")
    public ResponseEntity<Void> deleteClusterRole(@RequestBody DeleteClusterRoleReq req) throws ApiException {
        kubernetesClusterRoleService.deleteClusterRole(req.getClusterRoleName());
