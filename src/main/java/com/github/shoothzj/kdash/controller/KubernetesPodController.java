...
public class KubernetesPodController {
    ...
    @PutMapping("/namespaces/{namespace}/pods")
    ...
    @PutMapping("/namespaces/{namespace}/pods/yaml")
    public ResponseEntity<Void> createPodByYaml(@PathVariable String namespace,
                                          @RequestBody YamlReq req) throws Exception {
        kubernetesPodService.createPodByYaml(namespace, req);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }
