...
public class KubernetesServiceAccountController {

    private final KubernetesServiceAccountService kubernetesServiceAccountService;

    public KubernetesServiceAccountController(@Autowired
                                              KubernetesServiceAccountService kubernetesServiceAccountService) {
