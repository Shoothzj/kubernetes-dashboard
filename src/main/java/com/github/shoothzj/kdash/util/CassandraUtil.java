...
public class CassandraUtil {
    ...
    public static CreateServiceParam service(CreateCassandraReq req) {
        CreateServiceParam createServiceParam = new CreateServiceParam();
        createServiceParam.setServiceName(KubernetesUtil.name("cassandra", req.getName()));
    ...
    public static CreateStatefulSetParam statefulSet(CreateCassandraReq req) {
        CreateStatefulSetParam createStatefulSetParam = new CreateStatefulSetParam();
        createStatefulSetParam.setStatefulSetName(KubernetesUtil.name("cassandra", req.getName()));
